...
app.get('/styles.bundle.js', function (req, res) {
		...
		res.render('styles.bundle.js', { pageCountMessage : null});
});

app.get('/styles.bundle.js.map', function (req, res) {

		res.render('styles.bundle.js.map', { pageCountMessage : null});
});

app.get('/vendor.bundle.js', function (req, res) {

		res.render('vendor.bundle.js', { pageCountMessage : null});
});
app.get('/vendor.bundle.js.map', function (req, res) {

		res.render('vendor.bundle.js.map', { pageCountMessage : null});
});
// error handling
